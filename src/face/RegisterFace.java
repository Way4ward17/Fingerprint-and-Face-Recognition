...
public class RegisterFace extends javax.swing.JFrame {
     ...
     */
    public RegisterFace() {
         super("Register Face | Face and Fingerprint Recognition");
        initComponents();
        getIdUser();
        startCamera();
        var.setFing(0); 
...
//		log.append(string + "\n");
    ...
    private void initComponents() {
        ...
        kGradientPanel9.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 10, 670, 40));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(picture, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        kGradientPanel9.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 70, 230, -1));

        getContentPane().add(kGradientPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1080, 510));
